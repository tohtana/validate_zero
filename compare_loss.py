...
def get_args():
    ...
    parser.add_argument('--atol', type=float, default=0.01, help='Absolute tolerance')
    ...
    parser.add_argument('--grad_accum_dtype', choices=['torch.bfloat16', 'torch.float16', 'torch.float32'], default=None, help='Override the universal optimizer gradient accumulation dtype')
